...
let Category = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)({ name: 'categories' })];
    ...
    var Category = _classThis = class {
        constructor() {
            ...
            this.products = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _products_initializers, void 0));
